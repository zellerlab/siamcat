...
#'  siamcat.split <- create.data.split(siamcat.example, num.folds=10, num.resample=5, stratify=TRUE)
#'
#'  ## # example with a variable which is to be inseparable
#'  ## siamcat.split <- create.data.split(siamcat.example, num.folds=10, num.resample=5, stratify=FALSE, inseparable='Gender')
