...
#' @param param.set a list of extra parameters for mlr run, may contain: \itemize{
...
#'
#'        The methods \code{"lasso"}, \code{"enet"}, and \code{"ridge"} are implemented
#'        as mlr-taks using the \code{"classif.cvglmnet"} Learner, \code{"lasso_ll"}
#'        and \code{"ridge_ll"} use the \code{"classif.LiblineaRL1LogReg"} and
