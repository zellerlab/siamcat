...
cwl_dir="/home/kbreuer/cwl_butler_workflow/CWL"
...
#cwltoil --logDebug --maxCores 8 --jobStore=$working_dir/jobstore --workDir=$temp_dir --basedir=$base_dir --outdir=$output_dir  ${cwl_dir}/workflows/butler_workflow.cwl $yml_job_filepath
