...
from the EMBL cluster. The raw data have been preprocessed and taxonomically
profiled with [mOTUs2](https://doi.org/10.1038/s41467-019-08844-4) and were 
...
# metadata
meta.all <- read.table(paste0(data.location, 'CD_meta/meta_all.tsv'),
