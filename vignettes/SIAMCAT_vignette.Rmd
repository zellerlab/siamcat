...
This vignette aims to be a short tutorial for the functionality of SIAMCAT. More
...
data are the same as used in the publication of [Zeller et al.](http://europepmc.org/abstract/MED/25432777), which demonstrated the
potential of microbial markers in feacal samples to distinguish patients with
...
The models are saved in the `model_list` slot of the `siamcat` object. For
example, the model trained on the first fold in the first repetition could
